...
const translations = {
  zh: {
    ...
    walkthroughIntro:
      "这一段不试图解释整个系统，只展示一条真实产品路径：先快速建立案情，再停在协定分支与来源链，随后带出 handoff artifact，最后落在产品明确保留的边界。",
    walkthroughCasePill: "CN -> NL dividends",
    walkthroughDeviceTitle: "真实产品演示",
    ...
    walkthroughChapter3Body: "先停在把案件缩窄到 Article 10 的协定分支。",
    walkthroughChapter4Title: "来源依据",
    walkthroughChapter4Body: "最长停留给支撑该分支的来源链，而不是只给一个税率结论。",
    walkthroughChapter5Title: "交接材料",
    walkthroughChapter5Body: "随后确认可交接给下一位复核人的 workflow-ready handoff。",
    walkthroughChapter6Title: "最终边界",
    walkthroughChapter6Body: "最后明确收在边界上：这是预审，不是最终税务意见。",
  ...
  en: {
    ...
    walkthroughCasePill: "CN -> NL dividends",
    walkthroughDeviceTitle: "Live product walkthrough",
    ...
    walkthroughChapter3Body: "First pause on the Article 10 branch that narrows the case.",
    walkthroughChapter4Title: "Provenance",
    walkthroughChapter4Body: "Stay longest on the source chain behind that branch.",
    walkthroughChapter5Title: "Handoff",
    walkthroughChapter5Body: "Then confirm the workflow-ready package for the next reviewer.",
    walkthroughChapter6Title: "Boundary",
    walkthroughChapter6Body: "Close on the explicit boundary: pre-review only, not a final tax opinion.",
